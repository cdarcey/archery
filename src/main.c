...
//   * fix bug (code commentted out at the bottom)  |
...
// causes bug when using ay_draw function
// need to diagnos and solve
...
//          0.75f,  0.75f, 1.0f, 1.0f, 1.0f, 0.0f, 0.0f, 0.5f, // bottom right
//     };
// 
//     // index buffer
//     uint32_t atIndexBuffer[6] = { 
