...
@rem call compiler
cl main.c ay_rasterize.c ay_threading_win32.c -Fe"../out/archery.exe" -Fo"../out/" -Od -Zi -nologo -I"../dependencies/GLFW/include" -I"../dependencies/stb" -MD -link -LIBPATH:"../dependencies/GLFW/libs" opengl32.lib glfw3.lib user32.lib gdi32.lib shell32.lib -incremental:no /WX 
