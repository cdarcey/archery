...
@rem call compiler
cl draw_test.c ../src/ay_rasterize.c ../src/ay_helpers.c -Fe"../out/archery.exe" -Fo"../out/" -Od -Zi -nologo -I"../src" -I"../dependencies/GLFW/include" -I"../dependencies/stb" -MD -link -LIBPATH:"../dependencies/GLFW/libs" opengl32.lib glfw3.lib user32.lib gdi32.lib shell32.lib -incremental:no /WX
